...
Help$initialize = function(a) {
    ...
    a.onclick = function(ev) {
        ...
        if (width != null) {
            $x('#HelpPopup').width(width);
            $x('#HelpContentFrame').width(width);
        }        
...
$ready(function() {
    let popup = $create('DIV', { id: 'HelpPopup', className: 'popup-autosize' }, { width: '500px', borderLeft: '1px solid #666666', boxShadow: '-2px -3px 4px #CCCCCC' }, { position: 'right', display: 'sidebar', modal: 'no'});
